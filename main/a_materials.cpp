...
void initTextures() {
    ...
    yellowtex = new ConstantTexture(RGBColor(0.7f, .7f, 0.f));
}
...
void a7prepMaterials4(Material** materials) {
    ...
    //CookTorranceMaterial* cooktor = new CookTorranceMaterial(yellowtex, 0.01, 0.2);
    //materials[3] = cooktor;
...
void a7renderCornellbox(float scale, const char* filename, Material** materials) {
    ...
    PerspectiveCamera cam(Point(278*scale, 273*scale, -800*scale), Vector(0, 0, 1), Vector(0, 0.37, 2.82), 0.686f, 0.686f);
...
void a_materials() {
    ...
    //a7renderCornellbox(0.001f, "a6-1cooktor.png", materials);
    delete [] materials;
}
